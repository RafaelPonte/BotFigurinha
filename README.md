...
<br>
<h2 align="center">✅ Versão Atualizada e Funcional - v3.5.0</h2>
<h2 align="center">🔄 Esta versão foi atualizada em 19/10/2025 com todas as dependências corrigidas!</h2>
<h3 align="center">📋 <a href="./ATUALIZACOES.md">Ver Detalhes da Atualização</a> | 🚀 <a href="./INICIO-RAPIDO.md">Guia de Início Rápido</a></h3>

<br>

## 🚀 INÍCIO RÁPIDO (Versão Atualizada)
...
Quando iniciar, escolha **opção 1 (QR Code)** e escaneie com seu WhatsApp!

📖 **[Ver Guia Completo de Início Rápido](./INICIO-RAPIDO.md)**
...
- **Node.js v18 ou superior** (recomendado v22)<br>
- **Yarn** instalado globalmente<br>
